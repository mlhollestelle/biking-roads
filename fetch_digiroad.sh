...
for KUNTA in 755 257 049 235 091 092 753 638 858 245 186 444 927 149 710 078 611 434 018 616 504 403 543 106 505
do
    ogr2ogr -nlt LINESTRING -f GPKG \
		...
		(KUNTAKOODI=$KUNTA) \
		AND TOIMINN_LK<6 AND TOIMINN_LK>3 AND LINKKITYYP<8"
done